...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "SotoAppFabric", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/AppFabric"),
        ...
        .target(name: "SotoBedrock", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/Bedrock"),
        .target(name: "SotoBedrockRuntime", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/BedrockRuntime"),
        ...
        .target(name: "SotoEntityResolution", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/EntityResolution"),
        ...
        .target(name: "SotoManagedBlockchainQuery", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/ManagedBlockchainQuery"),
        ...
        .target(name: "SotoMedicalImaging", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/MedicalImaging"),
        ...
        .target(name: "SotoPcaConnectorAd", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/PcaConnectorAd"),
